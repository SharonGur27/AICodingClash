...
This exercise will test your mastery of GitHub Copilot, Cline, and Roo by challenging you to build a complete game from scratch. You'll apply strategic planning, context building, and multi-tool coordination to create a polished gaming experience.
...
Choose your development approach based on your goals and preferences:

#### 🚀 Single Tool Focus
**Option A: Specialized Approach**
- Choose **one primary tool** (Copilot, Cline, or Roo)
- Master its specific strengths for your chosen game type
- Develop deep expertise in one workflow

#### 🔥 Multi-Tool Powerhouse
**Option B: Coordinated Development**
- Open **3 instances of VS Code**
...
- Leverage each tool's unique strengths:
  ...
  - **Roo**: Complex orchestration and mode specialization

#### 🎨 Model Diversity
**Option C: Model Comparison**
- Open **additional VS Code instances**
- Use **different AI models** across instances
- Compare outputs and approaches
- Synthesize the best solutions from each model
...
**For Roo Users:**
- **Game Development Mode**: Custom mode for game-specific patterns
- **UI/UX Mode**: Focus on user interface and experience
- **Testing Mode**: Specialized for game testing and validation
- **Documentation Mode**: Generate game rules and API documentation
...
#### ⏱️ Time Management
- **Planning Phase**: 25% of total time
- **Core Implementation**: 50% of total time
- **Testing and Polish**: 20% of total time
